...
type Store interface {
	Querier
	TransferTx(ctx context.Context, args CreateTransfersParams) (TransferTxResult, error)
}

// SQLStore provide all functions to excute SQL quries and transactions
...
func (store *SQLStore) TransferTx(ctx context.Context, args CreateTransfersParams) (TransferTxResult, error) {
